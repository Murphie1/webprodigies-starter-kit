  ...
  const createMeeting = async () => {
    ...
    try {
      ...
      if (!values.description) {
        router.push(`/socials/conferencing/${call.id}`);
      }
      toast({
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      <HomeCard
        ...
        handleClick={() => router.push('/socials/conferencing/calls')}
      />
      ...
      {!callDetail ? (
        ...
        >
          <div className="flex flex-col gap-2.5">
            ...
            <Textarea
              className="border-none bg-white dark:bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0"
              onChange={(e) =>
          ...
          <div className="flex w-full flex-col gap-2.5">
            ...
            <ReactDatePicker
              ...
              className="w-full rounded bg-white dark:bg-dark-3 p-2 focus:outline-none"
            />
          </div>
        </MeetingModal>
      ) : (

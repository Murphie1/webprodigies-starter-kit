import { TModelKey, useModelList } from "@/hooks/hakima/use-model-list";
          ...
          <DropdownMenuTrigger asChild>
            {
             ...
             <Heart />   {/*<SparklesIcon size={18} variant="stroke" strokeWidth="2" />*/}
                {messageAssistantProps?.model?.name}
                <Heart /> {/*<ArrowDown01Icon size={16} variant="stroke" strokeWidth="2" />*/}
              </Button>
            }
          </DropdownMenuTrigger>
        </Tooltip>

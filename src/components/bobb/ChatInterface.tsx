...
import { ChatRequestBody, StreamMessageType } from "@/lib/bobb/types";
import WelcomeMessage from "@/components/bobb/WelcomeMessage";
import { createSSEParser } from "@/lib/bobb/SSEParser";
import { MessageBubble } from "@/components/bobb/MessageBubble";
...
export default function ChatInterface({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("/api/bobb/chat/stream", {
        method: "POST",
  ...
  return (
    <main className="flex flex-col h-[calc(100vh-theme(spacing.14))]">
      {/* Messages container */}
      <section className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900 p-2 md:p-0">
        <div className="max-w-4xl mx-auto p-4 space-y-3">
          ...
          {isLoading && !streamedResponse && (
            <div className="flex justify-start animate-in fade-in-0">
              <div className="rounded-2xl px-4 py-3 bg-white text-gray-900 dark:bg-black dark:text-white rounded-bl-none shadow-sm ring-1 ring-inset ring-gray-200">
      ...
      {/* Input form */}
      <footer className="border-t bg-white dark:bg-black p-4">

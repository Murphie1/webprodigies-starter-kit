...
const BottomBar = () => {
    return (
        <div className="bg-gray-100 space-x-1 h-[65px] w-[calc(100vw-20px)] shadow-lg fixed bottom-[10px] left-[10px] z-50 justify-between items-center flex dark:bg-themeBlack rounded-xl">
            <Link href={`/home`}>
